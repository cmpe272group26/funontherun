package com.funontherun.services.utils;
...
import com.funontherun.utils.TrustAllSSLSocketFactory;
...
public class HTTPRequest {
	...
	public int execute(RequestMethod method) throws Exception {
		 ...
		 */
		if (!FunUtils.isConnectionAvailable(context))
			return Constants.FunOnTheRunDialogCodes.NETWORK_ERROR;
